...
// import * as keys from "@trakrlog.com/common/keys";
import { isValidEmail } from '@trakrlog/common/index'
 
export const Hero = () => {
    const x = isValidEmail("");
    console.log(x);
    return (
                    ...
                    <div className="text-center">
                        <h1 className="text-5xl font-bold tracking-tight text-balance text-white sm:text-8xl">
                            ...
                            <span className="relative whitespace-nowrap">
                                ...
                                <span className="relative bg-gradient-to-r from-white/70
                                 to-white bg-clip-text text-transparent">made simple</span>
                            </span>{' '}

                        </h1>
                        <p className="mt-8 font-medium text-pretty text-gray-400 sm:text-xl/8 max-w-xl mx-auto">
                            From critical bugs to users behavior, <b className="font-semibold text-white">TrakrLog</b> captures every detail around your product.
                        </p>
                        {/* {!keys.WAITLIST_ENABLED && ( */}
