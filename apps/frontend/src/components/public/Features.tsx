import { ClockIcon, ChartBarIcon, CubeIcon, UserGroupIcon, BellIcon, CodeBracketIcon } from '@heroicons/react/24/outline'
  ...
  return (
   <div className="bg-[var(--dark-bg)] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 mt-10">
        <div className="mx-auto max-w-5xl items-center text-center">
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-20">
                <dt className="text-xl/7 font-bold text-white">
                  <div className="absolute top-0 left-0 flex size-16 items-center justify-center 
