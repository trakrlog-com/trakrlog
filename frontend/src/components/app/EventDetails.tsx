...
export const EventDetails: React.FC = () => {
  ...
  const formattedDate = `${dateTime.toRelativeCalendar()} at ${dateTime.toLocaleString(
        ...
        <div className=" px-6 space-y-6">
          ...
          <div className="mt-6 border-t border-white/10">
            <dl className="divide-y divide-white/10">
              ...
              <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                <dt className="text-base font-medium text-gray-100">Tags</dt>
                <dd className="mt-2 text-sm  sm:col-span-2 sm:mt-0 text-white">
                  {selectedEvent.tags ? (
