        ...
        <div className="w-full max-w-md space-y-8">
          <div>
            <a href="/" className="mx-auto flex items-center">
              <img alt="TrakrLog logo" src="/logo-big.png" className="mx-auto h-20 w-auto" />
            </a>
            ...
            <div className="grid grid-cols-1 gap-4">
              <Button
                className="flex w-full items-center justify-center gap-3 rounded-md bg-white/10 px-3 py-2 text-sm 
                                font-semibold text-white inset-ring inset-ring-white/5
                                hover:bg-white/20 focus-visible:inset-ring-transparent"
              ...
              <Button
                className="flex w-full items-center justify-center gap-3 rounded-md bg-white/10 px-3 py-2 text-sm 
                                font-semibold text-white inset-ring inset-ring-white/5
                                hover:bg-white/20 focus-visible:inset-ring-transparent"
                onClick={() => authContext.loginClick("github")}
              >
                <svg
                  fill="currentColor"
                  viewBox="0 0 20 20"
